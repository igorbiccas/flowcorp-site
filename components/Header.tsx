    ...
    <>
        <nav className="fixed top-0 left-0 right-0 z-50 bg-black/20 backdrop-blur-xl">
            <div className="container mx-auto px-6 py-4 flex justify-between items-center border-b border-brand-border">
                <a href="#" className="text-xl font-bold text-brand-text tracking-wider transition-all duration-300 hover:text-white hover:drop-shadow-[0_0_10px_rgba(255,255,255,0.6)]" style={{textShadow: '0 0 10px rgba(255,255,255,0.3)'}}>Selfbrain</a>
            </div>
        </nav>

        <header className="relative pt-28 pb-20 md:pt-40 md:pb-32 flex items-center justify-center text-center overflow-hidden">
