...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    <a
      ...
      className="group relative flex h-full flex-col gap-4 overflow-hidden rounded-3xl border border-slate-200 bg-white p-8 shadow-[0_30px_80px_-60px_rgba(15,23,42,0.45)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_35px_90px_-60px_rgba(15,23,42,0.5)] focus:outline-none focus-visible:-translate-y-1 focus-visible:shadow-[0_35px_90px_-60px_rgba(15,23,42,0.5)] focus-visible:ring-2 focus-visible:ring-slate-300 focus-visible:ring-offset-2 focus-visible:ring-offset-white"
    >
