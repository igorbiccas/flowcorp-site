...
const ProblemSection: React.FC = () => {
  return (
    <section id="problem" className="py-16 md:py-28 relative">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="text-center md:text-left">
                ...
                <Animated delay={200}>
                  <div className="text-base md:text-lg text-brand-text-secondary max-w-xl mx-auto md:mx-0 leading-relaxed space-y-4 font-light">
