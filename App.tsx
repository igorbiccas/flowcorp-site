          ...
          <AnimatedSection className="w-full">
            <div className="mx-auto max-w-3xl space-y-8">
              ...
              <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                <a
                  href="#products"
                  className="inline-flex items-center justify-center rounded-full border border-white/20 bg-white px-6 py-2.5 text-sm font-semibold text-zinc-900 shadow-[0_25px_60px_-30px_rgba(250,250,250,0.6)] transition hover:border-white hover:bg-zinc-100"
                >
                  Explorar produtos
                </a>
                <a
                  href="mailto:hello@flowcorp.ai"
                  className="inline-flex items-center justify-center rounded-full border border-zinc-700/70 px-6 py-2.5 text-sm font-semibold text-zinc-200 transition hover:border-zinc-500/80 hover:text-white"
                >
                  Fale com a equipe
                </a>
              </div>
              <ul className="mx-auto flex max-w-xl flex-col gap-3 text-left text-sm text-zinc-400 sm:grid sm:grid-cols-2">
                <li className="flex items-start gap-2">
                  <span className="mt-1 inline-flex h-1.5 w-1.5 rounded-full bg-white" aria-hidden="true" />
        ...
        <section className="py-20 md:py-28">
          <div className="container mx-auto px-6 md:px-8">
            <AnimatedSection className="mx-auto max-w-4xl text-center">
              ...
              <h2 className="mt-6 text-3xl font-semibold tracking-tight text-zinc-100 md:text-4xl">
